...
from nemo.collections.asr.models.multi_ssl_models import SpeechEncMultiDecSelfSupervisedModel
...
def main(cfg):
    ...
    asr_model = SpeechEncMultiDecSelfSupervisedModel(cfg=cfg.model, trainer=trainer)
