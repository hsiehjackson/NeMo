...
class RelPositionMultiHeadAttentionLongformer(RelPositionMultiHeadAttention):
    ...
    def _compute_global_attn_output_from_hidden(
        ...
        batch_size = global_k.shape[0]
        seq_len = global_k.shape[2]

        global_k = global_k.reshape(batch_size * self.h, -1, self.d_k)
        global_v = global_v.reshape(batch_size * self.h, -1, self.d_k)
