...
class ContrastiveLoss(Loss):
    ...
    def __init__(
        ...
        norm_by_batchsize: bool = False,
        norm_by_target_number: bool = False,
        mult_factor: float = 1., #16000
    ):
        """
        ...
        self.norm_by_batchsize = norm_by_batchsize
        self.norm_by_target_number = norm_by_target_number
